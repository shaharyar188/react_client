...
export default function AmazonVirtual() {
    return (
        <>
            ...
            >
                <div className="auto-container">
                    <div className="title-outer">
                        <h1 className="title">Amazon Virtual Assistant</h1>
                    ...
                    <div className="row flex-xl-row-reverse">
                        ...
                        <div className="col-xl-8 col-lg-8">
                            <div className="courses-details__content">
                                <img
                                    src="assets/assets/images/new_assets/images/amazon_virtual.jpg"
                                    alt=""
                                    style={{ width: 722 }}
                                />
                                <h2 className="mt-4">Course Overview</h2>
                                <p>
                                    As a virtual assistant, you will be the primary point of contact
                                    for Amazon customers seeking assistance through various
                                    communication channels, including phone, email, and chat. Your
                                    responsibilities will include responding to customer inquiries,
                                    resolving customer issues, and offering product recommendations.{" "}
                                </p>
                                <div className="content mt-40">
                                    <div className="text">
                                        <h3>What You Will Learn?</h3>
                                        <p>
                                            Learning about Amazon's virtual assistant, such as Amazon
                                            Alexa, can be valuable for several reasons:
                                            <br />
                                            <strong className="fw-bold">
                                                Home Automation and Control:
                                            </strong>{" "}
                                            Amazon virtual assistants are often integrated into smart home
                                            devices, allowing you to control your lights, thermostat,
                                            locks, and more with voice commands. Learning how to use these
                                            features can make your home more convenient and efficient.
                                            <br />
                                            <strong className="fw-bold">Voice Shopping:</strong>You can
                                            shop for products on Amazon using voice commands. Learning how
                                            to use this feature can save you time and make online shopping
                                            more accessible.
                                            <br />
                                            <strong className="fw-bold">Information Retrieval:</strong>
                                            Amazon virtual assistants can provide you with answers to
                                            questions, weather updates, news, and much more. Understanding
                                            how to access this information can be helpful for staying
                                            informed.
                                            <br />
                                            <strong className="fw-bold">Entertainment:</strong>
                                            You can use Amazon virtual assistants to play music,
                                            audiobooks, and even control your TV. Learning how to use
                                            these features can enhance your entertainment experience.
                                            <br />
                                            <strong className="fw-bold">Productivity:</strong>
                                            Virtual assistants can help you set reminders, create to-do
                                            lists, and schedule appointments. Learning how to utilize
                                            these functions can boost your productivity.
                                        </p>
                                    </div>
