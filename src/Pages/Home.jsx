                    ...
                    >
                        <ul>
                            ...
                            <li data-index="rs-1" data-transition="zoomout">
                                ...
                                >
                                    <span className="title">START TO NEW JOURNEY WITH THE</span>
                                </div>
                                <div
                                    className="tp-caption"
                                    data-paddingbottom="[0,0,0,0]"
                                ...
                                >
                                    <div className="text mt-5">
                                        <strong className="text-dark fw-bold">In Nest Academy</strong>
                                        we educate the best courses for the learning <br /> and training
                                        and development programs developed by top teachers
                                    </div>
                                    <ul
                                        style={{
                                            display: "flex",
                                    ...
                                    >
                                        <li>
                                            ...
                                            <span className="ms-1">Free for physically handcraft</span>
                                        </li>
                                        <li className="ms-1">
                                            <i className="fas fa-check-circle" />
                                        ...
                                        <li className="ms-1">
                                            <i className="fas fa-check-circle" />
                                            <span className="ms-1">Easy to enroll courses</span>
                                        </li>
                                    </ul>
                                </div>
                                <div
                            ...
                            <div className="inner-column">
                                ...
                                <div className="sec-title">
                                    ...
                                    <div className="text">
                                        ...
                                        often take a back seat to business priorities but workplace. We
                                        offer fresh courses on emerging topics that keep your level.
                                    </div>
                                </div>
                                <ul className="list-style-two">
                                    <li>
                                        <i className="icon fa fa-book" /> Flexible unlimited training
                                        programs
                                    </li>
                                    <li>
                                        <i className="icon fa fa-book" /> Experience &amp; qualified
                                        teachers
                                    </li>
                                    <li>
                                        <i className="icon fa fa-book" /> Free incoming lessons
                                    </li>
                                </ul>
                                    ...
                                    <li className="accordion block">
                                        ...
                                        <div className="acc-content">
                                            <div className="content">
                                                <div className="text">
                                                    Online courses are easily accessible on much smaller
                                                    budgets. In addition to the convenience and the cost, a
                                                    large number of students are turning to online learning
                                                    courses
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className="auto-container">
                    <div className="outer-box">
                        ...
                        <div className="video-box wow fadeInUp">
                            ...
                            <Link
                                to="https://www.youtube.com/watch?v=0JmySpqBjl8"
                    ...
                    <div className="row">
                        ...
                        >
                            <div className="inner-box ">
                                ...
                                <h4 className="title">
                                    <Link to="/about">Industry instructors</Link>
                                </h4>
                                <div className="text">
                                    Whether you want to learn or to share what you know, you’ve come
                                    to the right place.
                        ...
                        >
                            <div className="inner-box ">
                                <figure className="image">
                                    <img
                                        src="assets/images/new_images/5.jpg"
                                        alt=""
                                        style={{ borderRadius: 10, height: 249 }}
                                    />
                                </figure>
                                <h4 className="title">
                                    <Link to="/about">Lifetime access</Link>
                                </h4>
                                <div className="text">
                                    Whether you want to learn or to share what you know, you’ve come
                                    to the right place.
                            ...
                            <div className="inner-column">
                                ...
                                <div className="counter-info-box">
                                    <div className="inner">
                                        ...
                                        <div className="text">students enrolled in our the academy</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="image-box">
                                    ...
                                    <div className="caption-box wow slideInRight">
                                        <div className="inner">
                                            ...
                                            <div className="text">
                                                Get your skills certificate from the Nest Academy
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="event-block col-lg-6">
                            <div className="inner-box">
                                <div className="content-box">
                                    ...
                                    <h5 className="title">
                                        <Link to="#">Starting IELTS Course form us.</Link>
                                    </h5>
                                    <ul className="post-info">
                                        <li>
                                            <i className="icon lnr-icon-history" />
                                            <span>Time:</span> 11:00am 01:00pm
                                        </li>
                                        <li>
                                            <i className="icon lnr-icon-location" />
                        ...
                        <div className="event-block col-lg-6">
                            <div className="inner-box">
                                <div className="content-box">
                                    ...
                                    <h5 className="title">
                                        <Link to="#">
                                            Starting NAT, NET, MD-CAT, E-CAT, etc. Course form us.
                                        </Link>
                                    </h5>
                                    <ul className="post-info">
                                        <li>
                        ...
                        <div className="event-block col-lg-6">
                            <div className="inner-box">
                                <div className="content-box">
                                    ...
                                    <h5 className="title">
                                        <Link to="#">
                                            Starting Amazon(Virtrual Assistant) Course form us.
                                        </Link>
                                    </h5>
                                    <ul className="post-info">
                                        <li>
                        ...
                        <div className="event-block col-lg-6">
                            <div className="inner-box">
                                <div className="content-box">
                                    ...
                                    <h5 className="title">
                                        <Link to="#">
                                            Starting freelancing Course form us.
                                        </Link>
                                    </h5>
                                    <ul className="post-info">
                                        <li>
