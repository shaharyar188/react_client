            ...
            >
                <div className="auto-container">
                    <div className="title-outer">
                        <h1 className="title">Sir Waqee Ahmed</h1>
                        <ul className="page-breadcrumb">
                            <li>
                                <Link to="/">Home</Link>
                            </li>
                            <li>Sir Waqee Ahmed</li>
                        </ul>
                    </div>
                </div>
            </section>
                            ...
                            <div className="col-xl-6 col-lg-6">
                                <div className="team-details__top-right">
                                    <div className="team-details__top-content">
                                        <h3 className="team-details__top-name">Sir Waqee Ahmed</h3>
                                        <p className="team-details__top-title">
                                            Computer-Science,Economics,General Methematics and Instructor
                                            for IT/Computer Based Courses Teacher
                                        </p>
